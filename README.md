...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/qibojit-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14117&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/qibojit-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `qibojit` can be installed with:

```
conda install qibojit
```

It is possible to list all of the versions of `qibojit` available on your platform with:
